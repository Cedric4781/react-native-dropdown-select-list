...
type SelectListProps = {
  ...
  maxHeight?: number;
  data: L1Keys[];
  defaultOption?: L1Keys;
  searchicon?: React.ReactNode | boolean;
  arrowicon?: React.ReactNode | boolean;
  ...
  fontFamily?: string;
  showsVerticalScrollIndicator?: boolean; // MODIF : scroll visible
};
...
const SelectList: React.FC<SelectListProps> = ({
    ...
    closeicon = false,
    search = true,
    searchPlaceholder = "search", // MODIF : placeholder personnalisable
    ...
    dropdownShown = false,
    fontFamily,
    showsVerticalScrollIndicator = false, // MODIF : valeur par défaut
}) => {
            ...
            {(dropdown && search) ?
                <View style={[styles.wrapper,boxStyles]}>
                    <View style={{flexDirection:'row',alignItems:'center',flex:1}}> 
                        ...
                        <TextInput 
                            placeholder={searchPlaceholder} // MODIF : placeholder dynamique
                            onChangeText={(val) => {
            ...
            {dropdown ?
                <Animated.View style={[{maxHeight:animatedvalue},styles.dropdown,dropdownStyles]}>
                    <ScrollView 
                        ...
                        showsVerticalScrollIndicator={showsVerticalScrollIndicator} // MODIF
                    >
